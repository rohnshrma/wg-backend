...
|---|---|---|---|
| 13 | Admissions CRM + Responsive | DONE, DRAG-DROP BROWSER-VERIFIED | Built 2026-07-28. 76 tests passing. **2026-07-28 follow-up:** drag-and-drop spot-checked in a real browser — works end-to-end (see Phase 13 section). Visual responsive breakpoints still not browser-verified. Found (unfixed): `config/passport.ts` crashes backend startup when Google OAuth env vars are unset. |
